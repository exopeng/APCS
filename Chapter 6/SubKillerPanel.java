...
public class SubKillerPanel extends JPanel {
    ...
    //needs ref to scorePanel to inform it to increment score
    ...
    //this way Bomb can go through SubKillerPanel and have score updated
    public void incrementScore() {
    	scorePanel.setScore(scorePanel.getScore() + 1);
    	//want to update JLabel, not JPanel

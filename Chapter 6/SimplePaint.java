...
public class SimplePaint extends JPanel implements MouseListener, MouseMotionListener {
    ...
    //	System.out.println("mouseDragged!");
        ...
        lines.add(new Line(prevX, prevY, x, y, currentColor));  // **** simply add the line to the ArrayList, will be drawn later
        repaint(); 	// ***Have System call paintComponent(), otherwise lines won't show up until you clicked the 
        				//the next color
